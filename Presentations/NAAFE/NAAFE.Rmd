...
- Aumento en la investigación multidisciplinar 
...
> - Una Base de metadatos fomenta la colaboración y facilita el proceso de apoyo a la toma de decisiones relevante a cualquier comunidad o región del país

</div>

## Objetivos del Proyecto

> 1. Diseñar la estructura de la base de metadatos de investigación relacionada con ecosistemas marinos y temas relacionados en México

<div class="green2">
> 2.** Identificar fuentes de datos disponibles e incorporar los metadatos de los mismos a la estructura**


</div>

> 3. Identificar tendencias en la disponibilidad de datos en México
> 4. Identificar información y vaciós de la misma que deberían ser tratados a futuro
> 5. Desarrollar protocolos para la publicación de la base de metadatos así como la incorporación de nuevos  registros
...
<img src="Images/Logos3.PNG" width=750 height=300>

> - <img src="Images/Unete.jpg" width=570 height=80>
...
>- **Difunde:** El éxito de este proyecto dependerá, en parte, de la cantidad de participantes involucrados y las distintas disciplinas que se logren reflejar

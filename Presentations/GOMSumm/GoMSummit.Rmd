...
K_data<- read.csv("~/Documents/Github/Meta_Data_Mexico/App_Eng/Metadata_Key.csv",
                    header = TRUE,
                    na="NA")
...
- Increasingly depending on multidiciplinary research
...
x <- fread("~/Documents/Github/Meta_Data_Mexico/App_Eng/Data_Curve.csv")
x <- x %>%
  select(-1)
